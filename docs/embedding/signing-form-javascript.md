...
```json
{
  ...
  "data-i18n": {
    ...
    "required": false,
    "default": "{}",
    "description": "JSON encoded string that contains i18n keys to replace the default UI text with custom values. See <a href=\"https://github.com/AmishHillBilly/EsignCenter/blob/master/app/javascript/submission_form/i18n.js\" class=\"link\" target=\"_blank\" rel=\"nofollow\">submission_form/i18n.js</a> for available i18n keys."
  },
  "data-go-to-last": {
    "type": "boolean",
    "required": false,
